...
##copy from build
##suggested to copy from build to NFS and create share for other servers
##create the rpm and then copy to home directory of build server
##cp /root/rpmbuild/RPMS/x86_64/helloworld-0.1-1.el7.x86_64.rpm /home/g42dfyt/
##chown it to be used by you
